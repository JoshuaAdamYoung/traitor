...
const poloKey = 'UUWO45RK-0PVF0G2S-5J0FQVAZ-1JJS19TL';
const poloSecret = 'e57548b6b0733afd968adba0149afe75306b1f3e7713e62ee75e10feb5d7504ca2ae83940ee0f330816440740ccaa80f4cc2c947e70b87822ac412601d99723d'; 


const plnx = require('plnx');
const Poloniex = require('poloniex.js');
const poloniex = new Poloniex(poloKey, poloSecret);
...
poloniex.returnChartData('USDT', 'BTC', 900, startChart, endChart, function(err, data) {
  if(err){
    console.log(err);
  }
  console.log(data);
